    ...
    <section className="mx-auto flex max-w-7xl flex-col gap-12 px-6 py-8 lg:px-8 lg:py-16">
      <div className="text-center">
        <h3 className="mb-2 text-4xl tracking-tighter lg:text-6xl">
          The <span className="text-foreground/50">Tech Stack</span>
        </h3>
...
export function ColumnAccordion({
  title,
  data,
}: {
  title: string;
...
export function TechStackRow({ name, context }: TechStackItem) {
  return (
    <div className="group flex w-full flex-col items-start gap-0 rounded-lg border-b border-zinc-200/50 p-0 transition-all duration-300 last:border-b-0 hover:bg-zinc-100 hover:shadow-sm md:gap-1 md:px-2 md:py-3 dark:border-white/5 dark:hover:bg-white/5">
