...
export default async function SelectedWork2() {
  return (
    <section className="mx-auto mt-12 flex max-w-7xl flex-col gap-4 px-6 py-8 lg:px-8 lg:py-12">
      ...
      {/* Oscar lab */}
      <Card interactive={true} orientation={"horizontal"}>
      ...
      <Card interactive={true} orientation={"horizontal"}>
        ...
        <div className="flex md:block">
          <CardHeader className="">
            ...
            <CardDescription>
              All-in-one dashboard for freelancers to manage projects, track
              time, invoice clients, and monitor finances. Built for solo
              developers who need simple, powerful tools.
            </CardDescription>
          </CardHeader>
