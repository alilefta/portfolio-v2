---
title: "Designing a checkout that cannot create ghost orders"
...
coverAlt: "Checkout workflow diagram showing an atomic order handoff"
...
items: {
    create: cart.items.map((item) => ({
        ...
        priceAt_time: item.product.price, // 🔒 Snapshot value
    })),
},
```
