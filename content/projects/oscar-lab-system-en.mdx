...
additional_info:
  {
    business_impact: "Built, deployed, and sold to an operating dental laboratory.",
  }
case_study:
  version: 3
  composition: "oscar"
  proposition: "A dependable desktop workspace for the operational and financial side of a dental laboratory."
  status: "shipped"
  role:
    ["Product discovery", "Product design", "Desktop engineering", "Delivery and support"]
  platform: ["Windows desktop"]
  capabilities:
    ["Case tracking", "Financial records", "Payroll", "Reporting", "Licensing and updates"]
  confidentiality: "limited"
  hero:
    src: "/images/projects/oscar-lab-system/oscar-lab-system-dark.png"
    alt: "Oscar Lab System dashboard showing operational and financial modules"
    caption: "The primary Oscar workspace brings cases, financial records, payroll, and reporting into one desktop product."
  thumbnail:
    src: "/images/projects/oscar-lab-system/oscar-lab-system-dark.png"
    alt: "Oscar Lab System dashboard"
  gallery:
    - id: "dashboard"
      src: "/images/projects/oscar-lab-system/oscar-lab-system-dark.png"
      width: 1917
  ...
  outcomes:
    - value: "Shipped + sold"
      ...
      evidence: "Owner-verified; the supporting commercial record is private."
      confidence: "owner-verified"
screenshots:
  {
  dark_screenshot_url: "oscar-lab-system-dark.png",
    theme: "dark",
    ext: "png",
  }
